...
bool ITouchInputHandling::OnMultiTouchStart(float x, float y, int32_t pointers /* = 2 */)
{
  if (m_handler)
...
bool ITouchInputHandling::OnMultiTouchEnd(float x, float y, int32_t pointers /* = 2 */)
{
  if (m_handler)
...
bool ITouchInputHandling::OnTouchGesturePanStart(float x, float y)
{
  if (m_handler)
...
bool ITouchInputHandling::OnTouchGesturePanEnd(float x, float y, float offsetX, float offsetY, float velocityX, float velocityY)
{
  if (m_handler)
