...
public:
  ...
  bool LoadVideoInfo(const std::string& strFilenameAndPath,
                     CFileItem& item,
  ...
  int SetDetailsForTvShowInTransaction(
  ...
  void DeleteTvShowInTransaction(int idTvShow, bool bKeepId = false, bool deleteChildren = true);
  ...
  /*! \brief Update last synced date of the import with the given path
   \param sourceIDentifier identifier of the source
   */
  void UpdateImportLastSynced(const CMediaImport& import,
   ...
   */
  bool SetImportForItem(int idMedia,
  ...
  */
   ...
   */
  bool GetPathForImportedItem(int idMedia,
                              const MediaType& mediaType,
                              const CMediaImport& import,
...
protected:
  ...
  bool UpdateDetailsForTvShow(int idTvShow,
                              ...
                              const std::map<int, std::map<std::string, std::string>>& seasonArt,
                              bool withTransaction);
  void DeleteTvShow(int idTvShow, bool bKeepId, bool deleteChildren, bool withTransaction);
...
private:
  ...
  void AppendImportFilter(const MediaType& mediaType,
                          const char* view,
                          const char* viewKey,
