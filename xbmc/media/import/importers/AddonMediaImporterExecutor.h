...
public:
  enum class Action
  {
    ...
    CanUpdatePlaybackMetadataOnSource,
    Import,
    UpdateOnSource,
...
protected:
  ...
  // make sure that the language invoker is not reused
  bool OverrideReuseLanguageInvoker() const override { return true; }
  bool OverriddenReuseLanguageInvoker() const override { return false; }
