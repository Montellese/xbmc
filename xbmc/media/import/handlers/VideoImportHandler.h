...
protected:
  ...
  void PrepareItem(CVideoDatabase& videodb, const CMediaImport& import, CFileItem* item);
  void SetDetailsForFile(CVideoDatabase& videodb, const CFileItem* item, bool reset);
