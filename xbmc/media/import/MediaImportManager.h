...
std::vector<std::string> MediaTypesToLabels(const MediaTypes& mediaTypes);

std::string MediaImportToLabel(const CMediaImport& import);

class CMediaImportManager : public IJobCallback, public IMediaImportTaskCallback, public IMediaImportHandlerManager
{
public:
  ~CMediaImportManager();
   ...
   */
  static CMediaImportManager& GetInstance();
  ...
  */
  ...
  virtual MediaImportHandlerConstPtr GetImportHandler(const MediaType& mediaType) const override;
   ...
   */
  bool AddSource(const std::string& sourceID, const std::string& basePath, const std::string& friendlyName, const std::string& iconUrl = "", const MediaTypes& mediaTypes = MediaTypes());

  /*!
   * \brief Adds a discovered source synchronously
   *
   * \param sourceID Unique identifier of the source
   * \param basePath Base path (VFS path) of the source
   * \param friendlyName Friendly name of the source
   ...
   * \param mediaTypes Media types supported by the source
   */
  bool AddSourceSync(const std::string& sourceID, const std::string& basePath, const std::string& friendlyName, const std::string& iconUrl = "", const MediaTypes& mediaTypes = MediaTypes());
   ...
   */
  bool ActivateSource(const std::string& sourceID, const std::string& basePath = "", const std::string& friendlyName = "", const std::string& iconUrl = "");
  ...
  */
  ...
  virtual bool OnTaskComplete(bool success, const IMediaImportTask *task) override;

private:
  CMediaImportManager() = default;
  CMediaImportManager(const CMediaImportManager&) = delete;
  CMediaImportManager const& operator=(CMediaImportManager const&) = delete;

  bool AddSourceInternal(const std::string& sourceID, const std::string& basePath, const std::string& friendlyName, const std::string& iconUrl, const MediaTypes& mediaTypes, bool synchronous);
  ...
  std::map<const char*, MediaImporterPtr> m_importers;
