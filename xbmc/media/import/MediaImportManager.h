...
public:
  ...
  *
  * \param repositoryManager media import repository manager
  */
  void Initialize(IMediaImportRepositoryManager* repositoryManager = nullptr);
  ...
  */
   ...
   */
  bool AddImport(const std::string& sourceID, const GroupedMediaTypes& mediaTypes);
   ...
   */
  bool AddImports(const std::string& sourceID, const std::set<GroupedMediaTypes>& mediaTypes);
