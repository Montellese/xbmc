...
public:
  ...
  virtual CMusicVideoImportHandler* Create() const override { return new CMusicVideoImportHandler(m_importHandlerManager); }

  virtual MediaType GetMediaType() const override { return MediaTypeMusicVideo; }
