  ...
  const char* const JSONRPC_SERVICE_TYPES[] = {  
    ...
    "\"Addon.Types\": {"
      ...
      "\"enum\": [ \"unknown\", \"xbmc.metadata.scraper.albums\", \"xbmc.metadata.scraper.artists\", \"xbmc.metadata.scraper.movies\","
                ...
                "\"xbmc.python.subtitles\", \"xbmc.python.lyrics\", \"xbmc.python.library\", \"xbmc.gui.skin\", \"xbmc.gui.webinterface\","
    ...
    "\"Addon.Fields\": {"
      "\"extends\": \"Item.Fields.Base\","
      "\"items\": { \"type\": \"string\","
        "\"enum\": [ \"name\", \"version\", \"minversion\", \"license\", \"summary\", \"description\", \"path\", \"author\", \"source\","
                  "\"icon\", \"disclaimer\", \"changelog\", \"fanart\", \"dependencies\", \"broken\", \"extrainfo\", \"rating\", \"enabled\" ]"
      "}"
    "}",
    "\"Addon.Details\": {"
      "\"extends\": \"Item.Details.Base\","
