...
Settings::Settings(std::shared_ptr<CSettingsBase> settings,
...
void Settings::OnSettingAction(const std::shared_ptr<const CSetting>& setting)
{
...
void Settings::IntegerSettingOptionsFiller(const std::shared_ptr<const CSetting>& setting,
...
void Settings::StringSettingOptionsFiller(const std::shared_ptr<const CSetting>& setting,
