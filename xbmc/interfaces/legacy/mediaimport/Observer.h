...
/// @{
/// @brief **Observer for media importer add-ons**
///
/// \python_class{ xbmcmediaimport.Observer() }
///
/// The observer is used by media importer add-ons to implement the available
/// callbacks executed by the media import core logic whenever something
/// related to media providers and / or media imports changes (added, updated
/// or removed). Therefore a media importer add-on can provide one class which
/// derives from Observer.
///
/// It is important that the implementation of the callbacks do NOT block
/// execution for too long because it will block the media import core logic.
///
///-----------------------------------------------------------------------
/// @python_v19
//
