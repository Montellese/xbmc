...
// TODO(Montellese)
#else
void setProviderSettingsLoaded(int handle, bool settingsLoaded);
#endif

#ifdef DOXYGEN_SHOULD_USE_THIS
// TODO(Montellese)
#else
void setImportSettingsLoaded(int handle, bool settingsLoaded);
#endif
...
SWIG_CONSTANT2(int,
               ...
               static_cast<int>(MediaImportChangesetType::Added));
SWIG_CONSTANT2(int,
               MediaImportChangesetTypeChanged,
               static_cast<int>(MediaImportChangesetType::Changed));
SWIG_CONSTANT2(int,
               MediaImportChangesetTypeRemoved,
               static_cast<int>(MediaImportChangesetType::Removed));
}
}
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
