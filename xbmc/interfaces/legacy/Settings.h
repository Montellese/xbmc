...
public:
  ...
  ///
  /// @return                        True if the settings were loaded.
  ///
  ///
  ///-----------------------------------------------------------------------
  /// @python_v19
  ...
  /// @param options             list of tuple - List of tuple containing the label and integer value of the option.
  /// @return                    True if the options have been set, false otherwise.
  ///
  ///
  ///-----------------------------------------------------------------------
  /// @python_v19
  ...
  /// @param options             list of tuple - List of tuple containing the label and string value of the option.
  /// @return                    True if the options have been set, false otherwise.
  ///
  ///
  ///-----------------------------------------------------------------------
