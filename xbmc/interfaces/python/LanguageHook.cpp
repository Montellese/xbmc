...
namespace XBMCAddon
{
  namespace Python
  {
    ...
    {
      XBMC_TRACE;
      CServiceBroker::GetXBPython().RegisterPythonMediaImporterObserverCallback(importerId,
                                                                                observer);
    }
    ...
    {
      XBMC_TRACE;
      CServiceBroker::GetXBPython().UnregisterPythonMediaImporterObserverCallback(importerId,
                                                                                  observer);
    }
