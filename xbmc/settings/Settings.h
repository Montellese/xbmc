...
public:
  ...
  CSetting* GetSetting(const std::string& id) const { return CSettingsBase::GetSetting(id); }
  bool GetBool(const std::string& id) const { return CSettingsBase::GetBool(id); }
  int GetInt(const std::string& id) const { return CSettingsBase::GetInt(id); }
  std::string GetString(const std::string& id) const { return CSettingsBase::GetString(id); }
