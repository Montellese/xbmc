...
#if !defined(TARGET_WINDOWS)
  ((CSettingString*)GetSettingsManager()->GetSetting(CSettings::SETTING_AUDIOOUTPUT_AUDIODEVICE))->SetDefault(CAEFactory::GetDefaultDevice(false));
  ((CSettingString*)GetSettingsManager()->GetSetting(CSettings::SETTING_AUDIOOUTPUT_PASSTHROUGHDEVICE))->SetDefault(CAEFactory::GetDefaultDevice(true));
#endif
...
#endif
  GetSettingsManager()->RegisterSettingOptionsFiller("aequalitylevels", CAEFactory::SettingOptionsAudioQualityLevelsFiller);
  GetSettingsManager()->RegisterSettingOptionsFiller("audiodevices", CAEFactory::SettingOptionsAudioDevicesFiller);
  GetSettingsManager()->RegisterSettingOptionsFiller("audiodevicespassthrough", CAEFactory::SettingOptionsAudioDevicesPassthroughFiller);
  GetSettingsManager()->RegisterSettingOptionsFiller("audiostreamsilence", CAEFactory::SettingOptionsAudioStreamsilenceFiller);
...
void CSettings::UninitializeOptionFillers()
{
  ...
  GetSettingsManager()->UnregisterSettingOptionsFiller("epgguideviews");
...
void CSettings::UninitializeISettingsHandlers()
{
  ...
  GetSettingsManager()->UnregisterCallback(&PERIPHERALS::CPeripherals::GetInstance());
#if defined(TARGET_DARWIN_OSX)
...
void CSettings::InitializeISettingCallbacks()
{
  ...
  settingSet.insert(CSettings::SETTING_LOCALE_LANGUAGE);
  GetSettingsManager()->RegisterCallback(&PERIPHERALS::CPeripherals::GetInstance(), settingSet);
...
void CSettings::UninitializeISettingCallbacks()
{
  ...
  GetSettingsManager()->UnregisterSettingsHandler(&CPlayerCoreFactory::GetInstance());
  GetSettingsManager()->UnregisterSettingsHandler(&CProfilesManager::GetInstance());
#ifdef HAS_UPNP
